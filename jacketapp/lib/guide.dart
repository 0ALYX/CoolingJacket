    ...
    if (_connectedYesNo == "Connected.") {
      setState(() {
        if (_roomOrDoorType == "Living Room") {
          ...
          if (_bulbImgPathBathroom == "images/light_off.png" &&
          ...
          if (_bulbImgPathHallway == "images/light_off.png" &&
          ...
          if (_padlockImgPathFrontDoor == "images/locked.png" &&
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              _buildRow("Bedroom", _bulbImgPathBedroom, _clrButtonBedroom,
                  _txtButtonBedroom),
              _buildRow("Children's Room", _bulbImgPathChildrensRoom,
                  _clrButtonChildrensRoom, _txtButtonChildrensRoom),
              _buildRow("Kitchen", _bulbImgPathKitchen, _clrButtonKitchen,
                  _txtButtonKitchen),
              _buildRow("Bathroom", _bulbImgPathBathroom, _clrButtonBathroom,
                  _txtButtonBathroom),
              _buildRow("Hallway", _bulbImgPathHallway, _clrButtonHallway,
                  _txtButtonHallway),
